from EW.to_import import acceptConsent, setUp, tearDown, URL_local, URL_detail_HDP, URL_detail_HDP_no_parameters, \
    URL_detail_HDP_DX_two_rooms, URL_detail_HDP_DS256_no_parameters, URL_detail_HDP_DX_no_parameters
import time
import unittest
