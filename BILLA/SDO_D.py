from BILLA.to_import import acceptConsent,URL_SDO, setUp, tearDown, generalDriverWaitImplicit
import time
import unittest
from BILLA.import_test_units_Xpaths import rowKarty_imgHoteluKarty_D
