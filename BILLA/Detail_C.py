...
from BILLA.to_import import acceptConsent, URL_detail, sendEmail, tearDown, setUp, URL_detail_all_inclusive, URL_detail_airport_praha
import time
...
class TestDetailHotelu_C(unittest.TestCase):
    ...
    def test_detail_terminy_filtr_meal(self):
        URL_detail_all_inclusive_lp = f"{self.URL}{URL_detail_all_inclusive}"
        self.driver.get(URL_detail_all_inclusive_lp)
    ...
    def test_detail_terminy_filtr_airport(self):
        URL_detail_airport_praha_lp = f"{self.URL}{URL_detail_airport_praha}"
            self.driver.get(URL_detail_airport_praha_lp)
