...
from KTGHU.to_import import acceptConsent, sendEmail, URL_stat, setUp, tearDown, generalDriverWaitImplicit
import time
import unittest
...
class TestSDO_D(unittest.TestCase):
    ...
    def test_SDO_D(self):
        ...
        try:
            mapa = driver.find_element(By.XPATH, "//*[@class='leaflet-pane leaflet-tile-pane']")
