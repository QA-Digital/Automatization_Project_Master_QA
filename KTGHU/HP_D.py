...
from KTGHU.to_import import acceptConsent,sendEmail, URL, URL_faq, setUp, tearDown, generalDriverWaitImplicit
import time
...
class TestHP_D(unittest.TestCase):
    ...
    def test_homePage_D(self):
        ...
        try:
            nejnabidkyLMsingle = self.driver.find_element(By.XPATH, "//*[@class='f_tourTable-tour']")
            nejnabidkyLMall = self.driver.find_elements(By.XPATH, "//*[@class='f_tourTable-tour']")
