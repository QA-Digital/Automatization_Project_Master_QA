...
def add_init_method_to_file(file_path):
    ...
    import_statement = 'from ND.to_import import URL_local\n'
    init_method = [
...
if __name__ == '__main__':
    project_directory = r'C:\Users\KDK\Desktop\DTCZ\kod\Automatization_Project_Master_QA\ND_Automation_Local_Deploy_PyCharm'  # Update with your project path
