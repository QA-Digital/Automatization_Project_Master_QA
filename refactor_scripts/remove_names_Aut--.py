...
if __name__ == "__main__":
    ...
    project_directory_path = r'C:\Users\KDK\Desktop\DTCZ\kod\Automatization_Project_Master_QA\KTGHU_Automation_Local_Deploy_PyCharm'


    # Old and new project names
    old_project_name = 'KTGHU_Automation_Local_Deploy_PyCharm'
    new_project_name = 'FWSK'
