...
from ND_Automation_Local_Deploy_PyCharm.DetskeKluby_D import *
...
from ND_Automation_Local_Deploy_PyCharm.poznavacky import *
...
def suite_EW_full():
    ...
    suite.addTest(TestFM_D("test_FM_zima"))
    suite.addTest(TestFM_D("test_FM_leto"))
